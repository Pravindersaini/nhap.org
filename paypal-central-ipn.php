...
$config = /* One line for each domain (follow the examples here please). */ array
	(
		"nhap.org" => "http://nhap.org/?s2member_paypal_notify=1"
		//"nhap.org" => "http://nhap.org/?s2member_paypal_notify=1&s2member_paypal_proxy=[proxy-gateway]&s2member_paypal_proxy_verification=6f1002545d25975845fd7b2812cc4258"
		/*
		"nhap.org" => "http://nhap.org/?s2member_paypal_notify=1"
		"http://nhap.org/?s2member_paypal_notify=1&s2member_paypal_proxy=[proxy-gateway]&s2member_paypal_proxy_verification=6f1002545d25975845fd7b2812cc4258"
...
//file_put_contents('/home/national/logs/debug.log', print_r($_p, true), FILE_APPEND);
