...
require_once( 'lib/tribe-community-events.class.php' );
require_once( 'lib/tribe-community-events-templates.class.php' );
require_once( 'vendor/tribe-common-libraries/tribe-common-libraries.class.php' );
require_once( 'lib/tribe-community-events-template-tags.php' );
require_once( 'lib/tribe-community-events-pue.class.php' );
new TribeCommunityEventsPUE( __FILE__ );
